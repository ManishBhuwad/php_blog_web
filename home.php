    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary navbg">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <a class="nav-link active" aria-current="page" href="#" onclick="preventDefault();">Home</a>
                        </li>
                        <li class="nav-item" style="margin-left:50px">
        ...
        <div class="ps">
            <div class="post-wrap">
                <div class="post-image  p-2 rounded">
                    <?php
                      echo  '<img src="includes/upload/'.$psid["image_data"].'" alt="image" width=100% height="100%">'
                    ?>
                </div>
                <div class="post-content-wrap">
                    ...
                    <div class="textcontent" >
                        ...
                        <div class="ps-bottom">
                            ...
                            <div class="post-anc-div"><a class="post-anc" href="includes/singlepost.inc.php?param=<?php echo urlencode($id) ?>">Read More</a></div>
                        </div>
                    </div>
                </div>
            </div>
